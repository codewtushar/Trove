        ...
        return StatefulBuilder(
          builder: (context, localSetState) {
            return AlertDialog(
              ...
              title: Text("Notification Settings",style: GoogleFonts.montserratAlternates(
              ...
              content: Column(
                ...
                children: [
                  Row(
                    children: [
                      Text("Enable Notifications",style: GoogleFonts.montserratAlternates(fontWeight: FontWeight.w600),),
                      Spacer(),
                      CupertinoSwitch(
                        value: notificationsEnabled,
                        onChanged: (value) {
                          localSetState(() {
                            notificationsEnabled = value; // IMPORTANT
                          });
                        },
                      ),
                    ],
                      ...
                      SnackBar(
                        content: Text(
                          notificationsEnabled
                              ...
                              : "Notifications disabled",style: GoogleFonts.montserratAlternates(fontWeight: FontWeight.bold),
                        ),
                      ),
                    );
                  },
                  child: Text("Save",style: GoogleFonts.poppins(color: Colors.green.shade900,fontWeight: FontWeight.w600),),
                ),
              ],
            );
          },
